...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = usuario.Preparar("cadatro"); erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
// DeletarUsuario deleta as informações de um usuário no banco de dados
...
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == uint64(usuarioID) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuario(db)
	if erro = repositorio.Seguir(uint64(usuarioID), seguidorID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuario(db)
	if erro = repositorio.PararDeSeguir(uint64(usuarioID), seguidorID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func BuscarSeguidores(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuario(db)
	seguidores, erro := repositorio.SeguirUsuario(usuarioID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar a senha um usuário que não seja o seu"))
		return
	}
